...
public class WeepingOcularRenderer extends GenericMinionRenderer<WeepingOcularEntity> {

    private static final float MODEL_SCALE = 1.0f;

    public WeepingOcularRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new GenericMinionModel<>());
    }

    @Override
    public void render(WeepingOcularEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
